        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5 sm:gap-6">
            {titleSponsors.map((sp) => (
              <div
                key={sp.name}
                className="group relative p-5 sm:p-6 rounded-2xl border border-cyan-500/25 hover:border-cyan-400 bg-gradient-to-b from-[#061226]/80 to-[#020714]/90 backdrop-blur-md shadow-xl hover:shadow-[0_0_35px_rgba(0,217,255,0.25)] transition-all duration-300 flex flex-col items-center justify-between gap-4 min-h-[170px]"
              >
